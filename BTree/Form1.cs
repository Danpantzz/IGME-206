...
namespace BTree
{
    public partial class Form1 : Form
    {
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 30; ++i)
            {
                node = new BTree(rand.Next(1, 52), root);
        ...
        private void Button5_Click(object sender, EventArgs e)
        {
            ...
            node = new BTree(26, null, false);
            root = node;

            node = new BTree(13, root, false);
            node = new BTree(6, root, false);
            node = new BTree(3, root, false);
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            node = new BTree("MICE", null);
            root = node;

            node = new BTree("GREY", root);
            node = new BTree("FROG", root);
            node = new BTree("APPLE", root);
            node = new BTree("CARROT", root);
            node = new BTree("TRICYCLE", root);
            node = new BTree("ZEBRA", root);
            node = new BTree("JACK", root);
            node = new BTree("WINDOW", root);
            node = new BTree("BLIND", root);
            node = new BTree("STRING", root);
            node = new BTree("DOG", root);
            node = new BTree("NUMBER", root);
            node = new BTree("OPEN", root);
            node = new BTree("YELL", root);

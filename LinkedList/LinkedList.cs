    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            string sentence = "Because I'm sad Clap along if you feel like a room without a roof Because I'm sad Clap along if you feel like sadness is the truth sad";
            s = sentence.Split();
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            linkedList.AddBefore(linkedListNode1, linkedListNode2.Value);
            linkedList.Remove(linkedListNode1.Value);

            linkedList.AddAfter(linkedList.First, linkedListNode1.Value);
            linkedList.Remove(linkedListNode2.Value);
